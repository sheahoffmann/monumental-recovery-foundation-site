...
(function () {
  ...
  if (giveForm) {
    ...
    giveForm.addEventListener("submit", function (e) {
      ...
      if (amount > 50000) {
        showError("For gifts over $50,000, email give@monumentalrecoveryfoundation.org and we will handle it personally.");
        return;
      }
      ...
      fetch("/.netlify/functions/create-checkout-session", {
        ...
        .catch(function (err) {
          ...
          if (!message || /failed to fetch|networkerror|load failed/i.test(message)) {
            message = "We could not reach the payment system. Please try again, or email give@monumentalrecoveryfoundation.org.";
          }
          showError(message);
